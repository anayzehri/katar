...
setTheme(localTheme); // Set initial theme

themeToggle.addEventListener('click', () => {
    const newTheme = container.classList.contains('dark-theme') ? 'light' : 'dark';
    setTheme(newTheme);
...
function handleMovement(targetIndex) {
    if (selectedPieceIndex !== null) {
        if (boardState[targetIndex] === null && neighbors[selectedPieceIndex].includes(targetIndex)) {
